...
#shannon_pairwise.py -f ${A}-test.tok.ref.tok -l $LANG > results_shannon/shannon_test-${A}_REF.out
#shannon_pairwise.py -f test-${A}-RBMT.unk.tok -l $LANG > results_shannon/shannon_test-${A}_RBMT.out
#shannon_pairwise.py -f test-${A}-SMT-NOUNK.out.final.tok -l $LANG > results_shannon/shannon_test-${A}_SMT.out
#shannon_pairwise.py -f test-${A}-LSTM-BPE.out.final.tok -l $LANG > results_shannon/shannon_test-${A}_LSTM.out
#shannon_pairwise.py -f test-${A}-TRANS-BPE.out.final.tok -l $LANG > results_shannon/shannon_test-${A}_TRANS.out
